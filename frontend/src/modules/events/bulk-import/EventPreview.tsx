/**
 * Events Bulk Import - Event Preview Component
 */
...
interface EventPreviewProps {
  item: ParsedItem<EventFormData>;
  isSelected: boolean;
  onToggle: () => void;
}

export function EventPreview({ item, isSelected, onToggle }: EventPreviewProps) {
  ...
  try {
    if (event.event_date && item.isValid) {
    ...
    logger.warn('Failed to format event date', {
      error,
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-muted-foreground mb-1">
                {event.people_involved || (
                  <span className="italic">No people specified</span>
                )}
              </p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-destructive mb-1">
                    Row {item.rowNumber} - Cannot import this event:
                  </p>
