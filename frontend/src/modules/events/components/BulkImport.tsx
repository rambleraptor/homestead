      ...
      {!file && (
        <Card className="p-6">
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <label
              htmlFor="csv-upload"
              className="inline-flex items-center justify-center font-medium transition-colors rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 bg-blue-600 hover:bg-blue-700 text-white focus:ring-blue-500 dark:bg-blue-500 dark:hover:bg-blue-600 px-4 py-2 text-base cursor-pointer"
            >
              Choose File
            </label>
          </div>
