...
const personSharedData: AepResourceDefinition = {
...
const address: AepResourceDefinition = {
  singular: 'address',
  plural: 'addresses',
  description:
...
export const peopleResources: AepResourceDefinition[] = [
  person,
  personSharedData,
  address,
];
